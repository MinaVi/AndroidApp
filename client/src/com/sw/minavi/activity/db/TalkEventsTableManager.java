...
public class TalkEventsTableManager {
	...
	public void InsertSample() {
		...
		String[][] datas = new String[][] {
				...
				{ "36", "11", "ミナ","ここは北海道大学です。" , "nomal_n", "0" , "0"},
				{ "37", "11", "ミナ", "文学研究科地域分析室に近いですね。。" , "nomal_n", "0" , "0"},
				
				{ "38", "12", "ミナ","地域分析しつではGISをはじめ\n様々なシステムを利用しています。" , "nomal_n", "0" , "0"},
				{ "39", "12", "ミナ", "実は私の生まれ故郷でもあるんですよ。" , "smile_n", "0" , "0"},
				
				{ "40", "13", "千棘","ここはホテル豊富よ！" , "chitoge", "0" , "0"},
				{ "41", "13", "千棘","ここは「ナトリウム塩化物泉」ていう種類の温泉らしいのよ。\nなんでも皮膚病にすっごくいいらしいの！" , "chitoge", "0" , "0"},
				{ "42", "13", "千棘","実は私もみんなと温泉って憧れてたんだー！" , "chitoge", "0" , "0"},
				
				{ "43", "14", "ブライト","そこ！タイル清掃遅いよ！\nなにやってんの！" , "buraito", "0" , "0"},
				{ "44", "14", "アムロ","少し張り切りすぎじゃないかブライト。\nみんなよくやってるよ。" , "amuro", "1" , "0"},
				{ "45", "14", "ブライト","アムロ！見損なったぞ！お前ならシャアを超え、\n世界一の温泉清掃員になれると思ったんだがな！" , "buraito", "0" , "0"},
				{ "46", "14", "アムロ","エゴだよそれは…" , "amuro", "1" , "0"},
				
				{ "47", "15", "ヤン","あー、早く退役して、ゆっくり温泉にでもつかりたいものだ。" , "yan", "0" , "0"},
				{ "48", "15", "アッテンボロー","お、出ましたね。先輩の十八番が。" , "attenboro", "1" , "0"},
				{ "49", "15", "ヤン","私はいつでも本気なんだけどね。ユリアンもつれてくるべきたったな。" , "yan", "0" , "0"},
				{ "50", "15", "アッテンボロー","グリーンヒル大尉の間違いじゃないですか？" , "attenboro", "1" , "0"},
				{ "51", "15", "ヤン","そうだね。っておまえなぁ！。" , "yan", "0" , "0"},
				
				{ "52", "16", "マーニー","あの入江で、わたしはあなたを待っている。永久にー" , "many", "0" , "0"},
				{ "53", "16", "マーニー","そろそろ戻らないと…今日は…" , "many", "0" , "0"},
				{ "54", "16", "マーニー","また私を探してね...それから誰にも言わないでね。約束よ" , "many", "0" , "0"},
