...
public class TalkEventsTableManager {
	...
	public void InsertSample() {
		...
		String[][] datas = new String[][] {
				...
				{ "40", "13", "千棘","ここはサロベツ原野よ！" , "chitoge", "0" , "0"},
				{ "41", "13", "千棘","ここは海岸砂丘とその背後にある宗谷丘陵によって阻まれた潟湖が、、泥炭による長い堆積作用によって形成されたらしいのよ。" , "chitoge", "0" , "0"},
				{ "42", "13", "千棘","泥炭は1年間に1mmしか形成されないらしいの。本当に気の長い話よね。" , "chitoge", "0" , "0"},
